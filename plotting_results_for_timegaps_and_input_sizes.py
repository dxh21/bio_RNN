...
#hidden24_neuronal_STPN_dynamicz = 
#hidden24_synaptic_STPN_dynamicz = 
...
#hidden48_neuronal_STPN_dynamicz = 
...
plt.legend(['Vanilla RNN', 'Neuronal STPN', 'Synaptic STPN', 'Bio GRU', 'Simple GRU', 'GRU'], prop={'size': 20})
